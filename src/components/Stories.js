...
const Stories =()=>{
  return<section className="stories" /*style={{display:"none"}}*/>
  ...
  <span>March 2nd 2020<strong> by John Appleseed</strong></span>
  ...
  <ArrowButton classButton="header-4 btn btn__active stories__btn  btn__color--white" text="Read the Story" classArrow="arrow--white"/>
  </div>
  </div>
